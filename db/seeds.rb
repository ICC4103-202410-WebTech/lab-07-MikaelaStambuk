...
posts = [
  Post.create!(title: "The Best Ski Athletes of 2023", content: "A detailed look at top athletes.", user: users[0], published_at: Time.zone.now),
  Post.create!(title: "Netflix Hits: Summer Reviews", content: "An overview of this summer's most watched movies.", user: users[1], published_at: Time.zone.now),
  Post.create!(title: "Exploring Pop Music", content: "Insights into the world of pop compositions.", user: users[2], published_at: Time.zone.now),
  Post.create!(title: "Why Dogs Make Great Pets", content: "Understanding the benefits of having a dog in your home.", user: users[3], published_at: Time.zone.now),
